...
let palette = {
    ...
    \   'search':           '                          guibg=#949494 ctermbg=240',
    \   'tab':              'guifg=#000000 ctermfg=0   guibg=#a8a8a8 ctermbg=248 term=None cterm=None',
    \   'tab-sel':          'guifg=#000000 ctermfg=0   guibg=#8c8c77 ctermbg=144',
    ...
    \
    \   'normal':           'guifg=#585858 ctermfg=240',
...
let palette = {
    ...
    \   'search':           '                          guibg=#878787 ctermbg=102',
